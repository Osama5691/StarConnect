    ...
    >
      ...
      <div className="relative z-10 flex h-full lg:flex-row flex-col">
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center items-start text-white p-12 lg:p-16 space-y-6">
          {/* Title and Info */}
          <div className="text-5xl lg:text-6xl font-bold mt-4 animate__animated animate__fadeIn">Contact Us</div>
          ...
          {/* Get in Touch Info */}
          <div className="bg-gray-900 bg-opacity-90 p-8 rounded-lg mt-6 shadow-lg transition-transform transform hover:scale-105 duration-300">
        ...
        <div className="w-full lg:w-1/2 flex justify-center items-center p-8 lg:p-16">
          <div className="bg-gray-900 bg-opacity-90 p-12 rounded-lg shadow-lg w-full max-w-lg transition-transform transform hover:scale-105 duration-300">
            <form>
